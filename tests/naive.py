...
def mpdist(T_A, T_B, m, percentage=0.05, k=None, T_A_subseq_isconstant=None, T_B_subseq_isconstant=None):
    percentage = min(percentage, 1.0)
    percentage = max(percentage, 0.0)
    n_A = T_A.shape[0]
    n_B = T_B.shape[0]
    ...
    P_ABBA[: n_A - m + 1] = stump(T_A, m, T_B, T_A_subseq_isconstant=T_A_subseq_isconstant, T_B_subseq_isconstant=T_B_subseq_isconstant)[:, 0]
    P_ABBA[n_A - m + 1 :] = stump(T_B, m, T_A, T_A_subseq_isconstant=T_B_subseq_isconstant, T_B_subseq_isconstant=T_A_subseq_isconstant)[:, 0]
