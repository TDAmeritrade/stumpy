...
check_errs $?
py.test -x -W ignore::RuntimeWarning -W ignore::DeprecationWarning tests/test_stumped.py tests/test_stumped_one_constant_subsequence.py tests/test_stumped_two_constant_subsequences.py tests/test_stumped_nan_inf_A_B_join.py tests/test_mstumped.py
check_errs $?
