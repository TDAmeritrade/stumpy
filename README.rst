...
Whether you are an academic, data scientist, software developer, or time series enthusiast, STUMPY is super easy to install and allows you to compute the `matrix profile <docs/Tutorial_0.ipynb>`_ in the most efficient way. Our goal is to allow you to get to your time series insights faster.
