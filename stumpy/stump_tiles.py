...
def _compute_tiles(
    ...
    sequentially along diagonal chunks using a single thread within the assigned tiles
...
def stump_tiles(T_A, m, T_B=None, ignore_trivial=True, normalize=True, p=2.0):
    """
